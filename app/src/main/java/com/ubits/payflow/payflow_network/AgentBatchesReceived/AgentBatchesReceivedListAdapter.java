...
public class AgentBatchesReceivedListAdapter extends BaseAdapter {
    ...
    class MyViewHolder {
        ...
        MyViewHolder(View view) {
            batchesreceivedtext = (TextView) view.findViewById(R.id.agent_batches_list_text);
            batchesreceivedcheckbox = (CheckBox) view.findViewById(R.id.agent_batches_list_checkbox);
        }
    }
